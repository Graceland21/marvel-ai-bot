...
# RESULT CHECK
# =========================
async def check_result(pair, entry_price, direction):
...
“””
    ...
    with open(”results.csv”, “a”) as f:
        f.write(f”{pair},{entry_price},{current_price},{result}\n”)
    ...
    while True:
        try:
            for pair in PAIRS:
                ...
                if entry_price:
                    await check_result(pair, entry_price, direction)
